                    ...
                    <div class="wrap_right_inner">
                        <table class="users_wrap">
                            <tr class="users_header">
                                ...
                                <td class="comments_number">작성 날짜</td>
                            ...
                            <c:forEach var="comment" items="${commentList }" varStatus="status">
                            	<tr class="users_data">
	                                ...
	                                <td class="comments_number">
	                                	<fmt:formatDate value="${comment.write_time }" pattern="yyyy.MM.dd." />
	                                </td>
	                                <td class="number">${comment.views }</td>
	                                <td class="number">${comment.reply_cnt }</td>
	                                <td class="comments_number">
	                                    <button class="userDeleteBtn" onclick="return deleteCommentConfirm('${comment.comment_id }')">삭제</button>
	                                </td>
	                            </tr>
                            </c:forEach>
                        </table>
